...
class MediaViewHelper
{
    ...
    protected function getDefaultPlayerMarkup($type, $src)
    {
        switch ($type) {
            case 'video':
                $vd = explode('/watch?v=',e($src));
                return '<iframe width="560" height="315" src="https://www.youtube.com/embed/'.$vd[1].'?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>';
